...
# source: imp/response/response.proto
...
from volcengine.imp.models.business import common_pb2 as imp_dot_business_dot_common__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='imp/response/response.proto',
...
_IMPRETRIEVEJOBRESPONSE_RESULTENTRY.fields_by_name['value'].message_type = imp_dot_business_dot_common__pb2._JOBEXECUTION
...
ImpSubmitJobResponse = _reflection.GeneratedProtocolMessageType('ImpSubmitJobResponse', (_message.Message,), {
  ...
  '__module__' : 'imp.response.response_pb2'
