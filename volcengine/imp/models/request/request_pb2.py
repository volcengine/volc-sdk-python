...
# source: imp/request/request.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='imp/request/request.proto',
...
_IMPSUBMITJOBREQUEST.fields_by_name['InputPath'].message_type = imp_dot_business_dot_common__pb2._INPUTPATH
...
ImpSubmitJobRequest = _reflection.GeneratedProtocolMessageType('ImpSubmitJobRequest', (_message.Message,), {
  ...
  '__module__' : 'imp.request.request_pb2'
