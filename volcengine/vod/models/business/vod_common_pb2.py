...
_VODSOURCEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Quality', full_name='Volcengine.Vod.Models.Business.VodSourceInfo.Quality', index=14,
...
_VODAUDIOSTREAMMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Quality', full_name='Volcengine.Vod.Models.Business.VodAudioStreamMeta.Quality', index=4,
...
_VODCOMMONCONFIGINFO = _descriptor.Descriptor(
  name='VodCommonConfigInfo',
  full_name='Volcengine.Vod.Models.Business.VodCommonConfigInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='Module', full_name='Volcengine.Vod.Models.Business.VodCommonConfigInfo.Module', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Key', full_name='Volcengine.Vod.Models.Business.VodCommonConfigInfo.Key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Value', full_name='Volcengine.Vod.Models.Business.VodCommonConfigInfo.Value', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VODPOINT = _descriptor.Descriptor(
  name='VodPoint',
  full_name='Volcengine.Vod.Models.Business.VodPoint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='Timestamp', full_name='Volcengine.Vod.Models.Business.VodPoint.Timestamp', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Value', full_name='Volcengine.Vod.Models.Business.VodPoint.Value', index=1,
...
_VODPLAYINFOMODEL.fields_by_name['AdaptiveInfo'].message_type = _VODADAPTIVEINFO
_VODPLAYINFOMODEL.fields_by_name['PlayInfoList'].message_type = _VODPLAYINFO
_VODPLAYINFOMODEL.fields_by_name['ThumbInfoList'].message_type = _VODTHUMBINFO
_VODPLAYINFOMODEL.fields_by_name['SubtitleInfoList'].message_type = _VODSUBTITLEINFO
...
DESCRIPTOR.message_types_by_name['VodCommonConfigInfo'] = _VODCOMMONCONFIGINFO
DESCRIPTOR.message_types_by_name['VodPlayInfoModel'] = _VODPLAYINFOMODEL
DESCRIPTOR.message_types_by_name['VodPoint'] = _VODPOINT
