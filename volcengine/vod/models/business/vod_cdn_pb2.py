...
_CONTENTINFO = _descriptor.Descriptor(
  name='ContentInfo',
  full_name='Volcengine.Vod.Models.Business.ContentInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='ItemId', full_name='Volcengine.Vod.Models.Business.ContentInfo.ItemId', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Url', full_name='Volcengine.Vod.Models.Business.ContentInfo.Url', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Status', full_name='Volcengine.Vod.Models.Business.ContentInfo.Status', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='TaskType', full_name='Volcengine.Vod.Models.Business.ContentInfo.TaskType', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='CreateTime', full_name='Volcengine.Vod.Models.Business.ContentInfo.CreateTime', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='TaskId', full_name='Volcengine.Vod.Models.Business.ContentInfo.TaskId', index=5,
...
_CDNTASKRESULT = _descriptor.Descriptor(
  name='CdnTaskResult',
  full_name='Volcengine.Vod.Models.Business.CdnTaskResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='TotalCount', full_name='Volcengine.Vod.Models.Business.CdnTaskResult.TotalCount', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='PageNum', full_name='Volcengine.Vod.Models.Business.CdnTaskResult.PageNum', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='PageSize', full_name='Volcengine.Vod.Models.Business.CdnTaskResult.PageSize', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ContentInfos', full_name='Volcengine.Vod.Models.Business.CdnTaskResult.ContentInfos', index=3,
...
_CDNTASKRESULT.fields_by_name['ContentInfos'].message_type = _CONTENTINFO
...
DESCRIPTOR.message_types_by_name['CdnTaskResult'] = _CDNTASKRESULT
...
CdnTaskResult = _reflection.GeneratedProtocolMessageType('CdnTaskResult', (_message.Message,), {
  'DESCRIPTOR' : _CDNTASKRESULT,
  '__module__' : 'vod.business.vod_cdn_pb2'
  # @@protoc_insertion_point(class_scope:Volcengine.Vod.Models.Business.CdnTaskResult)
  })
_sym_db.RegisterMessage(CdnTaskResult)
