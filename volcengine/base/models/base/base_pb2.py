...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='Volcengine.Base.Models.Base',
  syntax='proto3',
...
_RESPONSEMETADATA = _descriptor.Descriptor(
  ...
  full_name='Volcengine.Base.Models.Base.ResponseMetadata',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='RequestId', full_name='Volcengine.Base.Models.Base.ResponseMetadata.RequestId', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='Action', full_name='Volcengine.Base.Models.Base.ResponseMetadata.Action', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Version', full_name='Volcengine.Base.Models.Base.ResponseMetadata.Version', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Service', full_name='Volcengine.Base.Models.Base.ResponseMetadata.Service', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Region', full_name='Volcengine.Base.Models.Base.ResponseMetadata.Region', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Error', full_name='Volcengine.Base.Models.Base.ResponseMetadata.Error', index=5,
...
_RESPONSEERROR = _descriptor.Descriptor(
  name='ResponseError',
  full_name='Volcengine.Base.Models.Base.ResponseError',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='Code', full_name='Volcengine.Base.Models.Base.ResponseError.Code', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Message', full_name='Volcengine.Base.Models.Base.ResponseError.Message', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
