...
from volcengine.vod.models.request.request_vod_pb2 import VodGetRestoreVideoStatusRequest
...
if __name__ == '__main__':
    ...
    try:
        req = VodGetRestoreVideoStatusRequest()
        req.SpaceName = "your SpaceName"
        req.Vid = "your Vid"
        req.FileId = "your FileId"
        resp = vod_service.get_restore_video_status(req)
    except Exception:
        raise
    else:
        print(resp)
