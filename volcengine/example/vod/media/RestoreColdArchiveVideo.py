...
from volcengine.vod.models.request.request_vod_pb2 import VodRestoreColdArchiveVideoRequest
...
if __name__ == '__main__':
    ...
    try:
        req = VodRestoreColdArchiveVideoRequest()
        req.SpaceName = "your SpaceName"
        req.Vids = "your Vids"
        req.FileIds = "your FileIds"
        req.RestoreTier = "Standard"
        req.Days = "1"
        resp = vod_service.restore_cold_archive_video(req)
    except Exception:
        raise
    else:
        print(resp)
