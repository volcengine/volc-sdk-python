...
_VODQUERYUPLOADRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='VideoInfoList', full_name='Volcengine.Models.Vod.Business.VodQueryUploadResult.VideoInfoList', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VODQUERYUPLOADRESULT.fields_by_name['VideoInfoList'].message_type = _VODURLSET
